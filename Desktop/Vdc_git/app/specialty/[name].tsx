...
import { ArrowLeft, Search, Filter, Star, Clock, Video, MapPin, CircleCheck as CheckCircle, Award, SlidersHorizontal } from 'lucide-react-native';
...
export default function SpecialtyDoctorsScreen() {
  ...
  // Convert URL param back to readable name
  const specialtyName = typeof name === 'string' 
  ...
  const doctors = [
    ...
    },
    {
      ...
      distance: '1.8 km',
      consultationTypes: ['Video', 'In-Clinic'],
      awards: ['Excellence in Cardiac Care']
    },
    {
      id: 4,
  ...
  const filterOptions = [
    { id: 1, label: 'Availability', options: ['Today', 'Tomorrow', 'This Week'] },
    { id: 2, label: 'Consultation Fee', options: ['Under ₹500', '₹500-₹800', 'Above ₹800'] },
    { id: 3, label: 'Rating', options: ['4.5+', '4.0+', '3.5+'] },
    { id: 4, label: 'Experience', options: ['5+ years', '10+ years', '15+ years'] },
    { id: 5, label: 'Location', options: ['Bandra', 'Andheri', 'Mahim', 'Powai'] },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>{specialtyName}</Text>
      ...
      <View style={styles.searchContainer}>
        <View style={styles.searchBar}>
          ...
          <TextInput
            ...
            placeholder={`Search ${specialtyName.toLowerCase()}...`}
      ...
      <View style={styles.filtersContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filtersScroll}>
          <TouchableOpacity style={styles.filterChip}>
            <Text style={styles.filterChipText}>All Doctors</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.filterChip}>
            <Text style={styles.filterChipText}>Available Today</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.filterChip}>
            <Text style={styles.filterChipText}>Video Consultation</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.filterChip}>
      ...
      <View style={styles.resultsContainer}>
        <Text style={styles.resultsText}>{doctors.length} {specialtyName.toLowerCase()} found</Text>
            ...
            <View style={styles.doctorInfo}>
              ...
              <View style={styles.languages}>
                ...
                {doctor.languages.length > 2 && (
                  <Text style={styles.languageTag}>+{doctor.languages.length - 2}</Text>
                )}
              </View>
            </View>
